...
MapGroup_Olivine:
	...
	map OlivineRanch, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_39, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map OlivineQuarry, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_38, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Mahogany:
	...
	map Route49, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_42, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Dungeons:
	...
	map CianwoodCave, TILESET_CAVE, CAVE, LANDMARK_CIANWOOD_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map CherryTowerF1, TILESET_TOWER, DUNGEON, LANDMARK_CHERRY_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherryTowerF2, TILESET_TOWER, DUNGEON, LANDMARK_CHERRY_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherryTowerF3, TILESET_TOWER, DUNGEON, LANDMARK_CHERRY_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherryTowerF4, TILESET_TOWER, DUNGEON, LANDMARK_CHERRY_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherryTowerF5, TILESET_TOWER, DUNGEON, LANDMARK_CHERRY_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherryTowerRoof, TILESET_TOWER, DUNGEON, LANDMARK_CHERRY_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherryCave, TILESET_CAVE, CAVE, LANDMARK_ROUTE_47, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Azalea:
	...
	map AzaleaShore, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_33, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ForgottenPillar, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_47, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map CianwoodPalace, TILESET_JOHTO, ROUTE, LANDMARK_CIANWOOD_PALACE, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map GoldenrodIsle, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_41, LANDMARK_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_NewBark:
	...
	map CherryCutoff, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_46, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Cherrygrove:
	...
	map Route47, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_47, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
