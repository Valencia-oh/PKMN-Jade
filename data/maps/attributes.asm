...
ENDM
	...
	map_attributes CherrygroveCity, CHERRYGROVE_CITY, $35, WEST | NORTH | EAST
	connection west, Route47, ROUTE_47, -10
	...
	connection east, CherrygroveCity, CHERRYGROVE_CITY, 10
