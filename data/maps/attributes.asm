...
ENDM
	...
	connection south, ForgottenPillar, FORGOTTEN_PILLAR, 0
	...
	map_attributes AzaleaShore, AZALEA_SHORE, $05, WEST | EAST
	connection east, ForgottenPillar, FORGOTTEN_PILLAR, 0
	connection west, Route33, ROUTE_33, 2
