...
ENDM
	...
	connection south, AzaleaShore, AZALEA_SHORE, 8
	connection east, Route47, ROUTE_47, 20
	connection east, ForgottenPillar, FORGOTTEN_PILLAR, 35
	...
	connection south, OlivineQuarry, OLIVINE_QUARRY, 1
	...
	connection west, OlivineRanch, OLIVINE_RANCH, -3
	...
	connection west, CherryCutoff, CHERRY_CUTOFF, 3
	...
	connection south, ForgottenPillar, FORGOTTEN_PILLAR, -4
	...
	connection north, Route47, ROUTE_47, 4
	connection west, Route32, ROUTE_32, -35
	connection west, AzaleaShore, AZALEA_SHORE, -50

	map_attributes AzaleaShore, AZALEA_SHORE, $2c, NORTH | WEST | EAST
	connection north, Route32, ROUTE_32, -8
	connection east, ForgottenPillar, FORGOTTEN_PILLAR, 50
	...
	connection east, Route46, ROUTE_46, -3
	...
	connection east, Route39, ROUTE_39, 3
