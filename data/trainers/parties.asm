...
WhitneyGroup:
  ...
  db "WHITNEY@", TRAINERTYPE_MOVES
	...
	db 7
	dw WIGGLYTUFF
	dw MOONBLAST, SING, DRAININGKISS, METRONOME
	db 10
	dw MILTANK
	dw ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db 8
	...
	db 9
	dw FURRET
	dw BLIZZARD, FIRE_FANG, FURY_SWIPES, DEFENSE_CURL
	db -1 ; end
...
MortyGroup:
	...
	db 6
	dw VULPIX
	dw EMBER, PURSUIT, HAZE, NIGHT_SHADE
	db -1 ; end
...
PryceGroup:
	...
	db 6
	dw GLACEON
	dw POWDER_SNOW, MIST, BATON_PASS, BLIZZARD
	db -1 ; end
 ...
 next_list_item ; PRYCE (2)
	...
	dw DEWGONG
	db 9
	dw AURORA_BEAM, TAKE_DOWN, WATER_PULSE, SAFEGUARD
	dw JYNX
	dw PERISH_SONG, PSYBEAM, ICE_PUNCH, LOVELY_KISS
	db 10
	dw WYRDEER
	dw BLIZZARD, TAKE_DOWN, ZEN_HEADBUTT, HYPNOSIS
	db 10
	dw SNEASEL
	dw ICICLE_CRASH, AGILITY, SHADOW_CLAW, METAL_CLAW
	db 9
	dw MAMOSWINE
	dw BLIZZARD, EARTHQUAKE, MIST, ANCIENTPOWER
	db 10
	dw GLACEON
	dw BLIZZARD, POWDER_SNOW, BITE, MIST
	db -1 ; end
...
JasmineGroup:
	...
	db 6
	dw BRONZOR
	dw CONFUSION, STEEL_WING, SCREECH, HEADBUTT
	db 7
	dw PINECO
	dw PROTECT, TAKE_DOWN, RAPID_SPIN, HYPER_BEAM
	db -1 ; end
	...
	db 7
	dw STEELIX
	dw FIRE_FANG, SANDSTORM, ROCK_THROW, CRUNCH
	db 7
	dw MAGNETON
	...
	db 6
	dw SCIZOR
	dw WING_ATTACK, METAL_CLAW, SWORDS_DANCE, AGILITY
	db 7
	dw AMPHAROS
	dw POWER_GEM, THUNDER, FLASHCANNON, COTTON_SPORE
	db -1 ; end
...
ChuckGroup:
	...
	db 5
	dw HITMONTOP
	dw COUNTER, RAPID_SPIN, ROLLING_KICK, SWIFT
	db -1 ; end
	...
	db 8
	dw BRELOOM
	dw LOW_KICK, ICE_PUNCH, LEECH_LIFE, TOXIC
	db 8
	dw FALINKS
	dw ENDURE, MEGAHORN, COUNTER, FURY_CUTTER
	db 7 
	dw POLIWRATH
	dw BODY_SLAM, HYDRO_PUMP, RAIN_DANCE, THUNDERPUNCH
	end_list_items
...
ClairGroup:
	...
	db 7
	dw FLAPPLE
	dw SOLARBEAM, DRAGONBREATH, WING_ATTACK, QUICK_ATTACK
	db 7
	dw VOLCARONA
	dw PURSUIT, PIN_MISSILE, SUNNY_DAY, FLAMETHROWER
