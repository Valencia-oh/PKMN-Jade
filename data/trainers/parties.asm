...
MortyGroup:
	...
	db 26
	dw MIGHTYENA
	dw BITE, MEAN_LOOK, CRUNCH, SHADOW_BALL
	db -1 ; end
...
PryceGroup:
	...
	db 40
	dw WYRDEER
	dw HYPER_BEAM, ICY_WIND, PSYCHIC_M, REST
	db 39
	dw DEWGONG
	...
	db 45
	dw MAMOSWINE
	dw ICY_WIND, EARTHQUAKE, FURY_ATTACK, BLIZZARD
	db 43
	dw GLACEON
...
JasmineGroup:
	...
	db 30
	dw AMPHAROS
	dw THUNDER, THUNDERPUNCH, IRON_TAIL, THUNDER_WAVE
	db 37
	dw STEELIX
...
ChuckGroup:
	...
	db 28
	dw HITMONCHAN
	dw THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, TOXIC
	db 34
	dw HITMONLEE
	dw HI_JUMP_KICK, FOCUS_ENERGY, PROTECT, ROLLING_KICK
	db 31
	dw HITMONLEE
	dw METAL_CLAW, COUNTER, FURY_CUTTER, HEADBUTT
	db -1 ; end
...
ClairGroup:
	...
	db 42
	dw FLAPPLE
	dw NIGHT_SHADE, WHIRLWIND, SOLARBEAM, DRAGONBREATH
	db 50
	dw VOLCARONA
	dw CONFUSE_RAY, FLAMETHROWER, SOLARBEAM, PIN_MISSILE
	db -1 ; end
