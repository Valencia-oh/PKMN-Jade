...
KadabraEvosAttacks:
	...
	dbww EVOLVE_ITEM, LINK_CABLE, ALAKAZAM
	db 0 ; no more evolutions 
	dbw 1, TELEPORT
	dbw 1, KINESIS
	dbw 1, CONFUSION
...
MachokeEvosAttacks:
	...
	dbww EVOLVE_ITEM, LINK_CABLE, MACHAMP
	db 0 ; no more evolutions
	dbw 1, LOW_KICK
	dbw 1, LEER
	dbw 1, FOCUS_ENERGY
...
GravelerEvosAttacks:
	...
	dbww EVOLVE_ITEM, LINK_CABLE, GOLEM
	db 0 ; no more evolutions
	dbw 1, TACKLE
	dbw 1, DEFENSE_CURL
	dbw 1, ROCK_THROW
...
HaunterEvosAttacks:
	...
	dbww EVOLVE_ITEM, LINK_CABLE, GENGAR
	db 0 ; no more evolutions
	dbw 1, HYPNOSIS
	dbw 1, LICK
	dbw 1, SPITE
...
EeveeEvosAttacks:
	...
	dbww EVOLVE_ITEM, SHINYSTONE, GLACEON
	db 0 ; no more evolutions
	dbw 1, TACKLE
	dbw 1, TAIL_WHIP
	dbw 8, SAND_ATTACK
