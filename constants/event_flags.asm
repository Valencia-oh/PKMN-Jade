...
; Unused: next 48 events
	const EVENT_ICE_PATH_B2F_BLACKTHORN_SIDE_BEADS
	const EVENT_FOUGHT_MEW
	const EVENT_CHERRY_TOWER_ROOF_MEW
	const EVENT_SET_WHEN_FOUGHT_MEW
	const EVENT_FOUGHT_CHI_YU
	const EVENT_PALACE_CHI_YU
	const EVENT_SET_WHEN_FOUGHT_CHI_YU
	const EVENT_FOUGHT_MOLTRES
	const EVENT_GOLDENROD_MOLTRES
